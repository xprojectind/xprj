            ...
            if msg.text == "Gc":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        if ginfo.preventJoinByTicket == True:
                            ...
                            u = "open"
                            msg.contentType = 13
                            msg.contentMetadata = {'mid': gCreator.mid}
                    cl.sendMessage(msg)
            elif msg.text == "Ginfo":
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                cu = cl.channel.getCover(msg.contentMetadata[target])
                                cl.sendText(msg.to, "[coverURL]:\n" + str(cu))
                                print "SUKSES -- Getpict TARGET"
                            except:
                                pass
                ...
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                bio = cl.getContact.statusMessage
                for g in gs.members:
                    if _nametarget == g.displayName:
                        cl.sendText(msg.to,bio)
                    else:
                        pass
            elif "Group Creator" in msg.text:
                msg.contentType = 13
                ginfo = cl.getGroup(msg.to)
                gCreator = ginfo.creator.displayName
                try:
