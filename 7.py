...
cl = LINETCR.LINE()
cl.login(token="Elea79bteH4F72dS35b7.qpULbrRPYbZguXdtBjqiDW.6o+yHPywDXMkGgBNo4ZdE5Qov38QAusJZ/xBZ8lAPJw=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="ElUU9CdOwJhof9qB92He.Ui6+xW13t47V5fZjQTyYVG.XzMuVD0KvVztSDpnWXn2cTr0W99uZowmbfUbWjxsRFw=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EllB5VMHaPi2l2jmLGd7.h8wq4moe7azCzrO22g+jXW.KAjdosg+Qsx1Ok1K/oMjnFDdjbR3N0EvDiUtKrDKDBc=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="ElK3nT7rHYZnuFxogGB0.Cd3d8niaKPe4bqTU1xTaWa.fb/Jx8OEXuJi52zQqH8jJHfiBSZ/cFftS9Wxzwhn8gs=")
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token="ElnAtkEMIG7C79pQgbNc.HgIPXaGjwsLmlFO+0+Yv3a.9+bpgOqumrEtPQuBlPJA0M9FfyNeTnZwc4AICbS/Dq4=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="ElE0tnIoGydf5I42BKE1.tWMyGail59CbvDUARQ0Feq.6l9IF8mKiFiwE71OaaEFPbbHTyaxoa5QjYKhRms94/w=")
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token="ElAU8QkXIiTfWiRqZy6b.VuoUeauiyQIdnYn1ZQb02W.JxJxZs4TUkuXvHF/Q5VMJYlwUXqtSclel+J43cGZfKg=")
kf.loginResult()
...
helpMessage =""" Keyword Sagiri Bot

|=*=Key Member=*=|
➡️[Ginfo] Check Group Info
➡️[Gcreator] Show Created Group
➡️[Gcreator:inv] Invited Created Group
➡️[Banlist] Check Account Banned
➡️[Gift] Send Your Suprise
➡️[Gn] Free] Change Name Group
➡️[Me By TAG] / Me] Send CONTACT BY TAG / Send Your Contact
➡️[Mid By tag] / Mid] SHOW MID BY TAG / SHOW YOUR MID
➡️[Creator] LOOK CREATOR BOT SAGIRI
➡️[Staff] LOOK STAFF BOT SAGIRI
...
*********************************
"""
helpMessage3 =""" Keyword For Staff
...
*********************************
"""
Setgroup =""" Privasi Menu SAGIRI 􀔃􀄆red check mark􏿿
[Protect QR -- Qr on / off]
[Protect Kicker -- P on / off]
[Protect Invite -- Inv on / off]
...
adminMID = "uaa75cafbc718153f1b0e69998c51f4e7"
wait = {
    'protect':True,
    'protectinv':True,
    'protectqr':True,
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"====================================\nThanks for add me\nMy Creator Http://line.me/ti/p/~alifp.sikumbang\n====================================",
    "lang":"JP",
...
def bot(op):
	...
	if op.type == 19:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
            ...
            elif msg.text in ["Keystaff","keystaff","Help","key"]:
              if msg.from_ in admin:
                if wait["lang"] == "JP":
                    ...
                    print "SUKSES -- KEYWORD"
                    cl.sendText(msg.to,helpt)
            elif msg.text in ["SetGroup","Set Group","Set group"]:
              if msg.from_ in admin:
                if wait["lang"] == "JP":
		...
		link_re = cl.compile('(?:line\:\/|line\.me\/R)\/ti\/g\/([a-zA-Z0-9_-]+)?')
		links = link_cl.findall(msg.text)
		n_links=[]
		for l in links:
		    if l not in n_links:
	    		n_links.append(l)
		    ...
		    if wait["atjointicket"] == True:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Gcreator","GCreator","gcreator"]:
              if msg.toType == 2:
                    msg.contentType = 13
                    ginfo = cl.getGroup(msg.to)
              ...
              if msg.from_ in admin:
                ...
                msg.contentMetadata = {"mid": msg.from_}
                cl.sendMessage(msg)
            elif msg.text in ["Backup:on","backup:on","backup on","Backup on"]:
                if wait["Backup"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"already 🔛\n"+ datetime.today().strftime('%H:%M:%S'))
            elif msg.text in ["Backup:off","backup:off","backup off","Backup off"]:
		...
		if wait["protectqr"] == False:
            ...
            elif msg.text in ["Set View","Set","set view","set"]:
                md = ""
